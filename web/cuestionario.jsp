    ...
    <body>
        ...
        <div id="cuestionario">
         ...
         <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p2">
                    <label class="form-check-label" for="p2r2">
                      Mirar lo qué otros comen o mirar dibujos de cada platillo.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p2">
                    <label class="form-check-label" for="p2r3">
                      Escoger de las descripciones en el menú.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p2">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p3">
                    <label class="form-check-label" for="p3r2">
                      Tienes historias reales, experiencias y ejemplos.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p3">
                    <label class="form-check-label" for="p3r3">
                      Leyendo rápidamente partes de él.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p3">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p4">
                    <label class="form-check-label" for="p4r2">
                      Usando ejemplos de lo que usted ha hecho.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p4">
                    <label class="form-check-label" for="p4r3">
                      Usando gráficos que muestran lo que usted ha logrado.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p4">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p5">
                    <label class="form-check-label" for="p5r2">
                      Te de una página de internet o algo para leer.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p5">
                    <label class="form-check-label" for="p5r3">
                      Te describa lo qué está mal.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p5">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p6">
                    <label class="form-check-label" for="p6r2">
                      Es un diseño moderno y se mira bien.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p6">
                    <label class="form-check-label" for="p6r3">
                      Leer los detalles acerca de sus características.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p6">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p7">
                    <label class="form-check-label" for="p7r2">
                      Pienso cómo suena cada palabra y escojo una.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p7">
                    <label class="form-check-label" for="p7r3">
                      Busco la palabra en un diccionario.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p7">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p8">
                    <label class="form-check-label" for="p8r2">
                      Diseño interesante y características visuales.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p8">
                    <label class="form-check-label" for="p8r3">
                      Cosas que con un click pueda cambiar o examinar.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p8">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p9">
                    <label class="form-check-label" for="p9r2">
                      Describe algunos de los puntos sobresalientes.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p9">
                    <label class="form-check-label" for="p9r3">
                      Darles una copia del itinerario impreso.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p9">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p12">
                    <label class="form-check-label" for="p12r2">
                      Anote las direcciones en un papel (sin mapa).
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p12">
                    <label class="form-check-label" for="p12r3">
                      Les dice las direcciones.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p12">
        ...
        <div class="seccion_preg">
            ...
            <div class="pregunta">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="b" name="p14">
                    <label class="form-check-label" for="p14r2">
                      Folletos, libros o lecturas.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="c" name="p14">
                    <label class="form-check-label" for="p14r3">
                      Diagramas, esquemas o gráficos.
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="d" name="p14">
